...
(function (window) {
  ...
  var BITRIX_SOURCE_ID = "WEB";

  /* Пользовательские поля лида. Пока в константе есть 'XXXX',
     поле не отправляется — как в лендинге вступительных экзаменов. */
  var UF_ORGANIZATION   = "UF_CRM_1XXXXXXXXX";
  var UF_ATTENDEE_TYPE  = "UF_CRM_2XXXXXXXXX";
  var UF_QUESTION       = "UF_CRM_3XXXXXXXXX";
  var UF_PAGE_LANGUAGE  = "UF_CRM_4XXXXXXXXX";
  ...
  var EVENT = {
    ...
    mapUrl: "https://www.google.com/maps/search/?api=1&query=TEAM+University+Tashkent"
  };
  ...
  window.TPT_CONFIG = {
    ...
    UF_PAGE_LANGUAGE: UF_PAGE_LANGUAGE,
